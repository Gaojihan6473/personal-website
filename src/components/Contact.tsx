...
export function Contact() {
  ...
  return (
    <section id="contact" ref={sectionRef} className="h-full w-full relative flex flex-col justify-start lg:justify-center overflow-y-auto py-20 px-6 md:px-12 lg:px-20">
